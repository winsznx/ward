  ...
  { at: 12500, ev: { type: "state", state: "VERDICT", msg: "composing §9 verdict" } },
  {
    ...
    ev: {
      ...
      verdict: {
        ...
        contradictions: [],
        notes: "coverage gate CLEAR (full external-dominant corroboration across 2 distinct agents); GO gated only on content risk-scoring — a false GO in a safety tool is worse than caution. counterparties: Attestr[external], Degentel LP[external].",
